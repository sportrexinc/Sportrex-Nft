    ...
    <ParentLayout current={5}>
      <div className="w-full flex flex-col">
        <div className=" md:mt-[80px] flex flex-col items-center space-y-4">
          ...
          <div className="mx-auto w-full  md:w-2/12">
        ...
        <div className="flex justify-center items-center mt-12 xl:mt-40">
          <div className="flex-col w-full flex xl:w-4/12 mx-auto ">
            <h1 className="grad-text bold text-[22px] mb-6">
            ...
            <div className="flex items-center w-fit mx-auto text-[16px] light bg-blue-btn text-white px-6 py-2 cursor-pointer semibold mt-16 mb-32 ">
              Help center
            </div>
          </div>
        </div>
